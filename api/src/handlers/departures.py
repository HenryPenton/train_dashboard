...
async def get_departures_handler(origin_station_code: str, destination_station_code: str):
    """
    ...
    async with httpx.AsyncClient() as client:
        ...
        try:
            data = await rtt_client.get_departures(origin_station_code, destination_station_code)
