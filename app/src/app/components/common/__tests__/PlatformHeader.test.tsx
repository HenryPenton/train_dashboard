...
describe('PlatformHeader', () => {
  test('renders platform name with proper accessibility attributes', () => {
    ...
    expect(platformHeader).toHaveAttribute('aria-label', 'Platform section: Platform 3');
    ...
    expect(platformHeader).toHaveClass('text-sm', 'font-semibold', 'text-yellow-300', 'px-2');
  });
});