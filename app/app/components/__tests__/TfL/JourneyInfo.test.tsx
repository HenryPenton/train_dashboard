...
describe("JourneyInfo", () => {
  it("renders journey info with correct labels", () => {
    ...
    expect(screen.getByLabelText(/journey duration and arrival/i)).toHaveTextContent("42 min");
    expect(screen.getByLabelText(/journey duration and arrival/i)).toHaveTextContent("Arrival:");
    expect(screen.getByLabelText(/journey duration and arrival/i)).toHaveTextContent("Fare:");
  });
});
