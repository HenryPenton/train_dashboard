...
function fetchSchedules() {
  return fetch(`${API_URL}/schedules`).then((res) => res.json());
}
...
function saveSchedules(schedules: SchedulesDTO) {
...
export default function SchedulesPage() {
  const [schedules, setSchedules] = useState<SchedulesDTO>({ schedules: [] });
  ...
  return (
    <div className="max-w-2xl mx-auto p-4">
      ...
      <div className="mb-4 flex gap-3">
        ...
        >
          <span className="mr-2">🚆</span> Add Rail Departure
        </button>
        <button
          type="button"
        ...
        >
          <span className="mr-2">⭐</span> Add Best Route
        </button>
      </div>
      <form
        onSubmit={(e) => {
